...
// Возможные улучшения :
// 1.Реструктуризация массивов прописных значений, возможность генерации слов из одиннаковых корней.
// 2.Объединение методов для парсинга из двух, в один универсальный для целых и дробных значений.
// 3.Упрощение if ветвлений для лучшего восприятия.
// 4.Вынос кода для определения окончаний валюты в отдельные методы.
